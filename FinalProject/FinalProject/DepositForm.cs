...
namespace FinalProject
{
    public partial class DepositForm : Form
    {
        ...
        private void showBalanceButton_Click(object sender, EventArgs e)
        {
            ...
            if (result == DialogResult.OK)
            {
                ...
                else
                {
                    ...
                    depositBalanceButton.Enabled = true;
                }
            }
            ...
            try
            {
                ...
                while (true)
                {
                    ...
                    {
                        // display record
                        dCurrentBalanceTextBox.AppendText($"{client.Balance:C}");
                        temp = client.Balance;
        ...
        {
            amountToDeposit = decimal.Parse(dBalanceDepositTextBox.Text);
            temp += amountToDeposit;
            balanceAddedTextBox.Text = temp.ToString();
        }
